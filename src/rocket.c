...
void DefaultRocketVariables(RocketVariables *rocketvar, PhysicsConstants *constants)
{
    ...
    double launch_tube_section_1 = pow(0.0045, 2) * M_PI;
    double launch_tube_section_0 = pow(0.0045, 2) * M_PI;
    ...
    SetRocketVariable(rocketvar, "launch_tube_section_0", launch_tube_section_0, 0, 2.0 * launch_tube_section_0);
    ...
    SetRocketVariable(rocketvar, "initial_temperature", initial_temperature, 0, 2.0 * initial_temperature);
}
...
double GetInitialGasVolume(RocketVariables *rocketvar)
{
    return GetRocketVariable(rocketvar, "launch_tube_volume")
        ...
        * (GetRocketVariable(rocketvar, "launch_tube_section_1") 
            - GetRocketVariable(rocketvar, "launch_tube_section_0"));
}
